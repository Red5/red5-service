 ...
 * child-first delegation model. <i>Based on code from Ceki Gulcu</i>
 * 
...
public final class ChildFirstClassLoader extends URLClassLoader {
	...
	public ChildFirstClassLoader(URL[] urls) {
		...
		parentParent = this.parent.getParent() != system ? this.parent
				.getParent() : null;
	...
	private void dumpClassLoaderNames() {
		System.out
				.printf("[ChildFirstClassLoader] Classloaders:\nSystem %s\nParents Parent %s\nParent %s\nThis class %s\nTCL %s\n\n",
						system, parentParent, this.parent,
						ChildFirstClassLoader.class.getClassLoader(), Thread
